...
COLLECTION THUMBNAILS (Matte Lipsticks / Lip Glosses cards)
--------------------------------------------------------------
By default, each collection card on the homepage automatically shows the
photo of the most recently added product in that category — no setup
needed, it just updates itself as you add products.

If you want a specific photo to stick (instead of changing every time you
add a new product), go to admin.html → scroll to "Collection Thumbnails" →
click "Lock current photo" (uses the auto photo that's showing) or "Upload
& lock a photo" (uses a photo of your choice, doesn't have to belong to any
product). Click "Unlock" any time to go back to automatic mode.
